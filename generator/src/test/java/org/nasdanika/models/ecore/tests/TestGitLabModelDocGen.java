...
public class TestGitLabModelDocGen {
	...
	public void testGenerateGitLabModelDoc() throws IOException, DiagnosticException {
		List<EPackage> ePackages = Arrays.asList(EcorePackage.eINSTANCE, GitLabPackage.eINSTANCE);
		...
		Map<EPackage, URI> packageURIMap = Map.ofEntries(
			...
			Map.entry(GitLabPackage.eINSTANCE, baseActionURI)	
		);
				...
				if (element instanceof EObjectNode) {
					...
					if (target == topLevelPackage) {
						...
						if (processor instanceof WidgetFactory) {
							...
							if (topLevelPackage == GitLabPackage.eINSTANCE) { 							
