...
public class PipelineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PipelinePackage.DETAILED_STATUS: {
				DetailedStatus detailedStatus = (DetailedStatus)theEObject;
				T result = caseDetailedStatus(detailedStatus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PipelinePackage.ARTIFACTS_FILE: {
				ArtifactsFile artifactsFile = (ArtifactsFile)theEObject;
				T result = caseArtifactsFile(artifactsFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PipelinePackage.ARTIFACT: {
				Artifact artifact = (Artifact)theEObject;
				T result = caseArtifact(artifact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PipelinePackage.RUNNER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Detailed Status</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Detailed Status</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDetailedStatus(DetailedStatus object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Artifacts File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Artifacts File</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArtifactsFile(ArtifactsFile object) {
		return null;
	}
