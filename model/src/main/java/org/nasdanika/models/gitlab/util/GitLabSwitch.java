...
public class GitLabSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GitLabPackage.BLAME: {
				Blame blame = (Blame)theEObject;
				T1 result = caseBlame(blame);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GitLabPackage.DIFF: {
				Diff diff = (Diff)theEObject;
				T1 result = caseDiff(diff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GitLabPackage.DISCUSSABLE: {
				Discussable discussable = (Discussable)theEObject;
				T1 result = caseDiscussable(discussable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Blame</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Blame</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseBlame(Blame object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseDiff(Diff object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Discussable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Discussable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseDiscussable(Discussable object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseDiscussion(Discussion object) {
		return null;
	}
